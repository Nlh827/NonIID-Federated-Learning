...
def set_random_seed(seed, deterministic=True):
    """
    Fix random seeds for reproducible FL experiments.

    对应审稿意见：
    R1-C8: multiple random seeds / statistical reliability
    R1-C10: reproducibility
    """
    seed = int(seed)
...
def build_torch_generator(seed):
    """
    Build a deterministic torch.Generator for DataLoader shuffle.
    """
    g = torch.Generator()
